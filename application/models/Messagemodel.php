...
class Messagemodel extends CI_model{
	public function ownerDetails(){
		if(isset($_SESSION['uniqueid'])){
			...
			$res = $this->db->get('chatuser')->result_array();
			return $res;
		}
	}
	...
	public function logoutUser($status, $date){
		if(isset($_SESSION['uniqueid'])){
			...
			$this->db->query("UPDATE chatuser SET user_status = '$status' , last_logout = '$date' WHERE 
	...
	public function updateBio($data){
		if(isset($_SESSION['uniqueid'])){
			...
			$this->db->query("UPDATE chatuser SET bio = '$bio', dob = '$dob', address = '$address', phone = '$phone' WHERE unique_id = '$session_id'");
			// return $data;
		}
	}
